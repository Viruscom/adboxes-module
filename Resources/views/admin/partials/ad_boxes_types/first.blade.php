<div class="row">
    <div class="col-xs-12">
        <h3>@lang('adboxes::admin.adboxes.index'): @lang('adboxes::admin.ad_boxes_type_1')</h3>
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                <?php $i = 1;?>
                @forelse ($adBoxesAdminAll[1] as $adBox)
...
<div class="row">
    <div class="col-md-12">
        <a href="{{ url('admin/adboxes/1/editButton') }}" class="btn btn-light-green">{{ (isset($adboxButtons[0]) && $adboxButtons[0]->title !='') ? $adboxButtons[0]->title : 'Бутон 1' }}</a>
    </div>
</div>
