...
<div class="row">
    <div class="col-md-12">
        <a href="{{ route('admin.ad-boxes.edit-button', ['adBoxType' => 4]) }}" class="btn btn-light-green">{{ (isset($adboxButtons[3]) && $adboxButtons[3]->title !='') ? $adboxButtons[3]->title : 'Бутон 4' }}</a>
    </div>
</div>
