...
<div class="row">
    <div class="col-md-12">
        <a href="{{ route('admin.ad-boxes.edit-button', ['adBoxType' => 2]) }}" class="btn btn-light-green">{{ (isset($adboxButtons[1]) && $adboxButtons[1]->title !='') ? $adboxButtons[1]->title : 'Бутон 2' }}</a>
    </div>
</div>
