...
@section('scripts')
    ...
    <script>
        ...
        $('.pickPositionTr').click(function () {
            $('.pickPositionTr').removeClass('active');
        ...
        <div class="row">
            <div class="col-sm-6 col-xs-12">
                <ul class="nav nav-tabs">
                    @foreach($languages as $language)
                        <li @if($language->code === config('default.app.admin_language.code')) class="active" @endif>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            @if($adBox->isWaitingAction())
                                                ...
                                                <p class="help-block file-rules-5 hidden">{!! $fileRules[AdBox::$FIFTH_TYPE]['file_rules'] !!}</p>
                                            @else
