<section class="section-products">
    ...
    <div class="section-actions" data-aos="fade-up" data-aos-delay="40">
        <a href="{{ url('/') }}" class="btn btn-black">{{ trans('messages.all_products') }}</a>
    </div>
...
<section class="section-kareta-1">
    ...
    <div class="kareta1">
        ...
        <div class="box" data-aos="fade-up">
            <div class="box-image-wrapper">
                <div class="box-status box-status-promo">
                    Promo
                </div>
            ...
            <div class="box-content">
                ...
                <p>
                    Eiusmod tempor incididunt ut labore etsd dhha dolore magna aliqua atenim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. </p>
        ...
        <div class="box" data-aos="fade-up">
            ...
            <div class="box-content">
                <h3>
                    <a href="">Light micellar water</a>
                </h3>

                <p>
                    Dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore etsd dhha dolore magna ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. </p>
    ...
    <div class="section-footer" data-aos="fade-up" data-aos-delay="200">
        <a href="" class="link-more-big">see ALL products</a>
    </div>
</section>
