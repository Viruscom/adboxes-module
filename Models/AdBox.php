...
class AdBox extends Model implements TranslatableContract
{
    ...
    public static string $AD_BOX_1_FIELD_NAME    = 'adbox_first';
    public static string $AD_BOX_2_FIELD_NAME    = 'adbox_second';
    public static string $AD_BOX_3_FIELD_NAME    = 'adbox_third';
    public static string $AD_BOX_4_FIELD_NAME    = 'adbox_fourth';
    ...
    public function setKeys($array): array
    {
        ...
        $array[1]['field_name']     = self::$AD_BOX_1_FIELD_NAME;
        ...
        $array[2]['field_name']     = self::$AD_BOX_2_FIELD_NAME;
        ...
        $array[3]['field_name']     = self::$AD_BOX_3_FIELD_NAME;
        ...
        $array[4]['field_name']     = self::$AD_BOX_4_FIELD_NAME;
