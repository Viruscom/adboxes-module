...
class AdBox extends Model implements TranslatableContract
{
    ...
    public static $IMAGES_PATH            = "images/adboxes";
    ...
    public static $AD_BOX_4_MIMES         = "jpg,jpeg,png,gif";
    public static $AD_BOX_1_RATIO         = "1/1";
    public static $AD_BOX_2_RATIO         = "1/1";
    public static $AD_BOX_3_RATIO         = "1/1";
    public static $AD_BOX_4_RATIO         = "1/1";
    public static $AD_BOX_1_MAX_FILE_SIZE = "3000";
    public static $AD_BOX_2_MAX_FILE_SIZE = "3000";
    public static $AD_BOX_3_MAX_FILE_SIZE = "3000";
    public static $AD_BOX_4_MAX_FILE_SIZE = "3000";
    ...
    public function setKeys($array): array
    {
        ...
        //        $array[1]['file_rules_message'] = FileDimensionHelper::getUserInfoMessage('AdBoxes', 1);
